...
asn_TYPE_descriptor_t asn_DEF_sensingResult_r15_3 = {
	...
	{ &asn_OER_type_sensingResult_r15_constr_3, &asn_PER_type_sensingResult_r15_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_MeasResultSensing_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultSensing_r15, sl_SubframeRef_r15),
		...
		0,
		{ &asn_OER_memb_sl_SubframeRef_r15_constr_2, &asn_PER_memb_sl_SubframeRef_r15_constr_2,  memb_sl_SubframeRef_r15_constraint_1 },
		0, 0, /* No default value */
		"sl-SubframeRef-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultSensing_r15, sensingResult_r15),
		...
		0,
		{ &asn_OER_memb_sensingResult_r15_constr_3, &asn_PER_memb_sensingResult_r15_constr_3,  memb_sensingResult_r15_constraint_1 },
		0, 0, /* No default value */
		"sensingResult-r15"
		},
};

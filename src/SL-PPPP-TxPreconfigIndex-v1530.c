...
asn_TYPE_descriptor_t asn_DEF_mcs_PSSCH_Range_r15_2 = {
	...
	{ &asn_OER_type_mcs_PSSCH_Range_r15_constr_2, &asn_PER_type_mcs_PSSCH_Range_r15_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_SL_PPPP_TxPreconfigIndex_v1530_1[] = {
	{ ATF_POINTER, 1, offsetof(struct SL_PPPP_TxPreconfigIndex_v1530, mcs_PSSCH_Range_r15),
		...
		0,
		{ &asn_OER_memb_mcs_PSSCH_Range_r15_constr_2, &asn_PER_memb_mcs_PSSCH_Range_r15_constr_2,  memb_mcs_PSSCH_Range_r15_constraint_1 },
		0, 0, /* No default value */
		"mcs-PSSCH-Range-r15"
		},
};

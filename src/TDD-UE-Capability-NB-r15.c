 ...
 */
static asn_oer_constraints_t asn_OER_type_ue_Category_NB_r15_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_ue_Category_NB_r15_2 = {
	...
	{ &asn_OER_type_ue_Category_NB_r15_constr_2, &asn_PER_type_ue_Category_NB_r15_constr_2, NativeEnumerated_constraint },

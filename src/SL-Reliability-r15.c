 ...
 */
static asn_oer_constraints_t asn_OER_type_SL_Reliability_r15_constr_1 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_SL_Reliability_r15 = {
	...
	sizeof(asn_DEF_SL_Reliability_r15_tags_1)
		/sizeof(asn_DEF_SL_Reliability_r15_tags_1[0]), /* 1 */
	{ &asn_OER_type_SL_Reliability_r15_constr_1, &asn_PER_type_SL_Reliability_r15_constr_1, SL_Reliability_r15_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};

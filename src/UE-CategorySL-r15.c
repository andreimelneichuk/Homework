...
asn_TYPE_member_t asn_MBR_UE_CategorySL_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UE_CategorySL_r15, ue_CategorySL_C_TX_r15),
		...
		0,
		{ &asn_OER_memb_ue_CategorySL_C_TX_r15_constr_2, &asn_PER_memb_ue_CategorySL_C_TX_r15_constr_2,  memb_ue_CategorySL_C_TX_r15_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UE_CategorySL_r15, ue_CategorySL_C_RX_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_ue_CategorySL_C_RX_r15_constr_3, &asn_PER_memb_ue_CategorySL_C_RX_r15_constr_3,  memb_ue_CategorySL_C_RX_r15_constraint_1 },
		0, 0, /* No default value */

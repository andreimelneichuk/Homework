...
static asn_oer_constraints_t asn_OER_memb_logicalChannelIdentity_r15_constr_30 CC_NOTUSED = {
	{ 1, 1 }	/* (32..38) */,
	-1};
...
asn_TYPE_member_t asn_MBR_DRB_ToAddMod_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod, logicalChannelIdentity_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_logicalChannelIdentity_r15_constr_30, &asn_PER_memb_logicalChannelIdentity_r15_constr_30,  memb_logicalChannelIdentity_r15_constraint_1 },
		0, 0, /* No default value */

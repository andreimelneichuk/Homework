...
asn_TYPE_descriptor_t asn_DEF_srs_CapabilityPerBandPairList_r14_7 = {
	...
	{ &asn_OER_type_srs_CapabilityPerBandPairList_r14_constr_7, &asn_PER_type_srs_CapabilityPerBandPairList_r14_constr_7, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_BandParameters_v1430_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct BandParameters_v1430, srs_CapabilityPerBandPairList_r14),
		...
		0,
		{ &asn_OER_memb_srs_CapabilityPerBandPairList_r14_constr_7, &asn_PER_memb_srs_CapabilityPerBandPairList_r14_constr_7,  memb_srs_CapabilityPerBandPairList_r14_constraint_1 },
		0, 0, /* No default value */
		"srs-CapabilityPerBandPairList-r14"
		},
};

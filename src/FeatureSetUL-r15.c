...
asn_TYPE_descriptor_t asn_DEF_featureSetPerCC_ListUL_r15_2 = {
	...
	{ &asn_OER_type_featureSetPerCC_ListUL_r15_constr_2, &asn_PER_type_featureSetPerCC_ListUL_r15_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_FeatureSetUL_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct FeatureSetUL_r15, featureSetPerCC_ListUL_r15),
		...
		0,
		{ &asn_OER_memb_featureSetPerCC_ListUL_r15_constr_2, &asn_PER_memb_featureSetPerCC_ListUL_r15_constr_2,  memb_featureSetPerCC_ListUL_r15_constraint_1 },
		0, 0, /* No default value */
		"featureSetPerCC-ListUL-r15"
		},
};

...
static asn_oer_constraints_t asn_OER_type_crs_IntfMitigNumPRBs_r15_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_crs_IntfMitigNumPRBs_r15_7 = {
	...
	{ &asn_OER_type_crs_IntfMitigNumPRBs_r15_constr_7, &asn_PER_type_crs_IntfMitigNumPRBs_r15_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */

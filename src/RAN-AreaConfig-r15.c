...
asn_TYPE_descriptor_t asn_DEF_ran_AreaCodeList_r15_3 = {
	...
	{ &asn_OER_type_ran_AreaCodeList_r15_constr_3, &asn_PER_type_ran_AreaCodeList_r15_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_RAN_AreaConfig_r15_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RAN_AreaConfig_r15, ran_AreaCodeList_r15),
		...
		0,
		{ &asn_OER_memb_ran_AreaCodeList_r15_constr_3, &asn_PER_memb_ran_AreaCodeList_r15_constr_3,  memb_ran_AreaCodeList_r15_constraint_1 },
		0, 0, /* No default value */
		"ran-AreaCodeList-r15"
		},
};

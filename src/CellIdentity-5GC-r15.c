...
static asn_oer_constraints_t asn_OER_type_CellIdentity_5GC_r15_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_CellIdentity_5GC_r15_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellIdentity_5GC_r15, choice.cellId_Index_r15),
		...
		0,
		{ &asn_OER_memb_cellId_Index_r15_constr_3, &asn_PER_memb_cellId_Index_r15_constr_3,  memb_cellId_Index_r15_constraint_1 },
		0, 0, /* No default value */
		"cellId-Index-r15"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_CellIdentity_5GC_r15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_CellIdentity_5GC_r15_constr_1, &asn_PER_type_CellIdentity_5GC_r15_constr_1, CHOICE_constraint },

 ...
 */
static asn_oer_constraints_t asn_OER_type_EstablishmentCause_5GC_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_EstablishmentCause_5GC = {
	...
	sizeof(asn_DEF_EstablishmentCause_5GC_tags_1)
		/sizeof(asn_DEF_EstablishmentCause_5GC_tags_1[0]), /* 1 */
	{ &asn_OER_type_EstablishmentCause_5GC_constr_1, &asn_PER_type_EstablishmentCause_5GC_constr_1, NativeEnumerated_constraint },

...
static asn_oer_constraints_t asn_OER_type_operationModeInfo_r15_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_sib1_CarrierInfo_r15_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_systemFrameNumber_MSB_r15_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	4	/* (SIZE(4..4)) */};
...
static asn_oer_constraints_t asn_OER_memb_hyperSFN_LSB_r15_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
...
static asn_oer_constraints_t asn_OER_memb_schedulingInfoSIB1_r15_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_systemInfoValueTag_r15_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_spare_constr_15 CC_NOTUSED = {
	{ 0, 0 },
	9	/* (SIZE(9..9)) */};
...
asn_TYPE_descriptor_t asn_DEF_operationModeInfo_r15_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_operationModeInfo_r15_constr_7, &asn_PER_type_operationModeInfo_r15_constr_7, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_sib1_CarrierInfo_r15_12 = {
	...
	{ &asn_OER_type_sib1_CarrierInfo_r15_constr_12, &asn_PER_type_sib1_CarrierInfo_r15_constr_12, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_MasterInformationBlock_TDD_NB_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_TDD_NB_r15, systemFrameNumber_MSB_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_systemFrameNumber_MSB_r15_constr_2, &asn_PER_memb_systemFrameNumber_MSB_r15_constr_2,  memb_systemFrameNumber_MSB_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_TDD_NB_r15, hyperSFN_LSB_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_hyperSFN_LSB_r15_constr_3, &asn_PER_memb_hyperSFN_LSB_r15_constr_3,  memb_hyperSFN_LSB_r15_constraint_1 },
		0, 0, /* No default value */
		"hyperSFN-LSB-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_TDD_NB_r15, schedulingInfoSIB1_r15),
		...
		0,
		{ &asn_OER_memb_schedulingInfoSIB1_r15_constr_4, &asn_PER_memb_schedulingInfoSIB1_r15_constr_4,  memb_schedulingInfoSIB1_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_TDD_NB_r15, systemInfoValueTag_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_systemInfoValueTag_r15_constr_5, &asn_PER_memb_systemInfoValueTag_r15_constr_5,  memb_systemInfoValueTag_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MasterInformationBlock_TDD_NB_r15, spare),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_spare_constr_15, &asn_PER_memb_spare_constr_15,  memb_spare_constraint_1 },
		0, 0, /* No default value */
		"spare"
		},
};

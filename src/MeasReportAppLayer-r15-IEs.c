...
asn_TYPE_member_t asn_MBR_MeasReportAppLayer_r15_IEs_1[] = {
	{ ATF_POINTER, 3, offsetof(struct MeasReportAppLayer_r15_IEs, measReportAppLayerContainer_r15),
		...
		0,
		{ &asn_OER_memb_measReportAppLayerContainer_r15_constr_2, &asn_PER_memb_measReportAppLayerContainer_r15_constr_2,  memb_measReportAppLayerContainer_r15_constraint_1 },

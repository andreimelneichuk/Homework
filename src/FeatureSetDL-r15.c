...
asn_TYPE_descriptor_t asn_DEF_featureSetPerCC_ListDL_r15_3 = {
	...
	{ &asn_OER_type_featureSetPerCC_ListDL_r15_constr_3, &asn_PER_type_featureSetPerCC_ListDL_r15_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_FeatureSetDL_r15_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct FeatureSetDL_r15, featureSetPerCC_ListDL_r15),
		...
		0,
		{ &asn_OER_memb_featureSetPerCC_ListDL_r15_constr_3, &asn_PER_memb_featureSetPerCC_ListDL_r15_constr_3,  memb_featureSetPerCC_ListDL_r15_constraint_1 },
		0, 0, /* No default value */
		"featureSetPerCC-ListDL-r15"
		},
};

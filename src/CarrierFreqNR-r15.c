...
asn_TYPE_descriptor_t asn_DEF_subcarrierSpacingSSB_r15_6 = {
	...
	{ &asn_OER_type_subcarrierSpacingSSB_r15_constr_6, &asn_PER_type_subcarrierSpacingSSB_r15_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_CarrierFreqNR_r15_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CarrierFreqNR_r15, q_RxLevMin_r15),
		...
		0,
		{ &asn_OER_memb_q_RxLevMin_r15_constr_19, &asn_PER_memb_q_RxLevMin_r15_constr_19,  memb_q_RxLevMin_r15_constraint_1 },
		0, 0, /* No default value */
		"q-RxLevMin-r15"
		},
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqNR_r15, q_RxLevMinSUL_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_q_RxLevMinSUL_r15_constr_20, &asn_PER_memb_q_RxLevMinSUL_r15_constr_20,  memb_q_RxLevMinSUL_r15_constraint_1 },
		0, 0, /* No default value */
		"q-RxLevMinSUL-r15"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqNR_r15, q_QualMin_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_q_QualMin_r15_constr_23, &asn_PER_memb_q_QualMin_r15_constr_23,  memb_q_QualMin_r15_constraint_1 },
		0, 0, /* No default value */
		"q-QualMin-r15"
		},

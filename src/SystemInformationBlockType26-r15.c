...
static asn_oer_constraints_t asn_OER_memb_threshS_RSSI_CBR_r14_constr_9 CC_NOTUSED = {
	{ 1, 1 }	/* (0..45) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType26_r15_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType26_r15, threshS_RSSI_CBR_r14),
		...
		0,
		{ &asn_OER_memb_threshS_RSSI_CBR_r14_constr_9, &asn_PER_memb_threshS_RSSI_CBR_r14_constr_9,  memb_threshS_RSSI_CBR_r14_constraint_1 },
		0, 0, /* No default value */

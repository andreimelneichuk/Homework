...
asn_TYPE_member_t asn_MBR_CFI_Config_r15_1[] = {
	{ ATF_POINTER, 4, offsetof(struct CFI_Config_r15, cfi_SubframeNonMBSFN_r15),
		...
		0,
		{ &asn_OER_memb_cfi_SubframeNonMBSFN_r15_constr_2, &asn_PER_memb_cfi_SubframeNonMBSFN_r15_constr_2,  memb_cfi_SubframeNonMBSFN_r15_constraint_1 },
	...
	{ ATF_POINTER, 3, offsetof(struct CFI_Config_r15, cfi_SlotSubslotNonMBSFN_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_cfi_SlotSubslotNonMBSFN_r15_constr_3, &asn_PER_memb_cfi_SlotSubslotNonMBSFN_r15_constr_3,  memb_cfi_SlotSubslotNonMBSFN_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct CFI_Config_r15, cfi_SubframeMBSFN_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_cfi_SubframeMBSFN_r15_constr_4, &asn_PER_memb_cfi_SubframeMBSFN_r15_constr_4,  memb_cfi_SubframeMBSFN_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct CFI_Config_r15, cfi_SlotSubslotMBSFN_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_cfi_SlotSubslotMBSFN_r15_constr_5, &asn_PER_memb_cfi_SlotSubslotMBSFN_r15_constr_5,  memb_cfi_SlotSubslotMBSFN_r15_constraint_1 },
		0, 0, /* No default value */

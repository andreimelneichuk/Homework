...
static asn_oer_constraints_t asn_OER_type_ab_PerNRSRP_r15_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_ab_PerNRSRP_r15_8 = {
	...
	{ &asn_OER_type_ab_PerNRSRP_r15_constr_8, &asn_PER_type_ab_PerNRSRP_r15_constr_8, NativeEnumerated_constraint },

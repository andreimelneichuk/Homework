...
static asn_oer_constraints_t asn_OER_memb_heightUE_r15_constr_35 CC_NOTUSED = {
	{ 2, 0 }	/* (-400..8880) */,
	-1};
...
asn_TYPE_member_t asn_MBR_MeasResults_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResults, heightUE_r15),
		...
		0,
		{ &asn_OER_memb_heightUE_r15_constr_35, &asn_PER_memb_heightUE_r15_constr_35,  memb_heightUE_r15_constraint_1 },
		0, 0, /* No default value */
		"heightUE-r15"
		},
};

...
static asn_oer_constraints_t asn_OER_type_featureSetsDL_v1550_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
...
static asn_oer_constraints_t asn_OER_memb_featureSetsDL_v1550_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
...
asn_TYPE_descriptor_t asn_DEF_featureSetsDL_r15_2 = {
	...
	{ &asn_OER_type_featureSetsDL_r15_constr_2, &asn_PER_type_featureSetsDL_r15_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_featureSetsDL_PerCC_r15_4 = {
	...
	{ &asn_OER_type_featureSetsDL_PerCC_r15_constr_4, &asn_PER_type_featureSetsDL_PerCC_r15_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_featureSetsUL_r15_6 = {
	...
	{ &asn_OER_type_featureSetsUL_r15_constr_6, &asn_PER_type_featureSetsUL_r15_constr_6, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_featureSetsUL_PerCC_r15_8 = {
	...
	{ &asn_OER_type_featureSetsUL_PerCC_r15_constr_8, &asn_PER_type_featureSetsUL_PerCC_r15_constr_8, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_featureSetsDL_v1550_11 = {
	...
	{ &asn_OER_type_featureSetsDL_v1550_constr_11, &asn_PER_type_featureSetsDL_v1550_constr_11, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_FeatureSetsEUTRA_r15_1[] = {
	{ ATF_POINTER, 5, offsetof(struct FeatureSetsEUTRA_r15, featureSetsDL_r15),
		...
		0,
		{ &asn_OER_memb_featureSetsDL_r15_constr_2, &asn_PER_memb_featureSetsDL_r15_constr_2,  memb_featureSetsDL_r15_constraint_1 },
		0, 0, /* No default value */
		"featureSetsDL-r15"
		},
	{ ATF_POINTER, 4, offsetof(struct FeatureSetsEUTRA_r15, featureSetsDL_PerCC_r15),
		...
		0,
		{ &asn_OER_memb_featureSetsDL_PerCC_r15_constr_4, &asn_PER_memb_featureSetsDL_PerCC_r15_constr_4,  memb_featureSetsDL_PerCC_r15_constraint_1 },
		0, 0, /* No default value */
		"featureSetsDL-PerCC-r15"
		},
	{ ATF_POINTER, 3, offsetof(struct FeatureSetsEUTRA_r15, featureSetsUL_r15),
		...
		0,
		{ &asn_OER_memb_featureSetsUL_r15_constr_6, &asn_PER_memb_featureSetsUL_r15_constr_6,  memb_featureSetsUL_r15_constraint_1 },
		0, 0, /* No default value */
		"featureSetsUL-r15"
		},
	{ ATF_POINTER, 2, offsetof(struct FeatureSetsEUTRA_r15, featureSetsUL_PerCC_r15),
		...
		0,
		{ &asn_OER_memb_featureSetsUL_PerCC_r15_constr_8, &asn_PER_memb_featureSetsUL_PerCC_r15_constr_8,  memb_featureSetsUL_PerCC_r15_constraint_1 },
		0, 0, /* No default value */
		"featureSetsUL-PerCC-r15"
		},
	{ ATF_POINTER, 1, offsetof(struct FeatureSetsEUTRA_r15, featureSetsDL_v1550),
		...
		0,
		{ &asn_OER_memb_featureSetsDL_v1550_constr_11, &asn_PER_memb_featureSetsDL_v1550_constr_11,  memb_featureSetsDL_v1550_constraint_1 },
		0, 0, /* No default value */
		"featureSetsDL-v1550"
		},
};

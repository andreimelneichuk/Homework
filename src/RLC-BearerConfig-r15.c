...
static asn_oer_constraints_t asn_OER_type_RLC_BearerConfig_r15_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_logicalChannelIdentityConfig_r15_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RLC_BearerConfig_r15__setup__logicalChannelIdentityConfig_r15, choice.logicalChannelIdentity_r15),
		...
		0,
		{ &asn_OER_memb_logicalChannelIdentity_r15_constr_6, &asn_PER_memb_logicalChannelIdentity_r15_constr_6,  memb_logicalChannelIdentity_r15_constraint_5 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RLC_BearerConfig_r15__setup__logicalChannelIdentityConfig_r15, choice.logicalChannelIdentityExt_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_logicalChannelIdentityExt_r15_constr_7, &asn_PER_memb_logicalChannelIdentityExt_r15_constr_7,  memb_logicalChannelIdentityExt_r15_constraint_5 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_logicalChannelIdentityConfig_r15_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_logicalChannelIdentityConfig_r15_constr_5, &asn_PER_type_logicalChannelIdentityConfig_r15_constr_5, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_RLC_BearerConfig_r15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_RLC_BearerConfig_r15_constr_1, &asn_PER_type_RLC_BearerConfig_r15_constr_1, CHOICE_constraint },
